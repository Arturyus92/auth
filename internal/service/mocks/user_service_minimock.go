...
//go:generate minimock -i github.com/Arturyus92/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, user *model.UserToCreate) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, user *model.UserToCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *model.UserToCreate) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, user *model.UserToCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *model.UserToCreate) (i1 int64, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, user *model.UserToUpdate) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, user *model.UserToUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, user *model.UserToUpdate) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, user *model.UserToUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, user *model.UserToUpdate) (err error) {
